...
var CategoryController = /** @class */ (function () {
    ...
    CategoryController.new = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var name, category, categoryRepository, e_1;
        return __generator(_a, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    _b.sent(); //guardamos la categoria
                    return [3 /*break*/, 4];
                case 3:
                    e_1 = _b.sent();
