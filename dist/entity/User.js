...
var User = /** @class */ (function () {
    ...
    __decorate([
        (0, typeorm_1.Column)(),
        (0, class_validator_1.IsNotEmpty)() //campo que no pueden estar vacios
        ,
        (0, class_validator_1.IsEmail)() // campo que tiene que ser un email
        ,
    ...
    User = __decorate([
        (0, typeorm_1.Entity)(),
        (0, typeorm_1.Unique)(["email"]) // no se puede repetir el email
    ], User);
    return User;
}());
exports.User = User;
